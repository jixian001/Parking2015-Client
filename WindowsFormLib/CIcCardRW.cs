...
namespace WindowsFormLib
{
        ...
        interface IicCardRW
        {
            ...
            int WriteCard(Int16 nSector, Int16 nDBNum, byte[] bwrite, ref int nback);

            void TransStringTo16Char(string str, ref byte[] cstr);
        }

        class CIcCardRW : IicCardRW
        {
            #region  读写器操作动态库
            //1.
            ...
            /// <returns>返回值</returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_init", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
            ...
            /// </summary>
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "usb_init", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
            protected static extern int usb_init();
            ...
            /// <returns>返回值</returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_exit", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns>返回值</returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_request", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns>返回值</returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_anticoll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns>返回值</returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_select", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_authentication", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <param name="icdev">rf_init()返回的设备描述符</param>
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_halt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_read", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_write", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            [DllImport("umwrf32.dll", EntryPoint = "rf_load_key", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            [DllImport("umwrf32.dll", EntryPoint = "rf_load_key_hex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_reset", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            /// <returns></returns>
            [DllImport("umwrf32.dll", EntryPoint = "rf_beep", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            [DllImport("umwrf32.dll", EntryPoint = "a_hex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
            ...
            public CIcCardRW(int com, int nBaudRate, int strRequestCardMode, Int16 nAuthKeyMode)
            {
                mnCommNum = com;
                mnbantnum = nBaudRate;
            ...
            public bool ConnectCOM()
            {
                if (mnCommNum != 0)
                {
                    mnEquipDesc = rf_init(mnCommNum, mnbantnum);
                }
                else
                {
                    mnEquipDesc = usb_init();
                }
                if (mnEquipDesc >= 0)
                {
                    return true;
            ...
            public void TransStringTo16Char(string str, ref byte[] cstr)
            {
                int len = str.Length;
                ...
                {
                    int tt = (int)objs[i] * 16 + (int)objs[i + 1];
                    bs[i / 2] = Convert.ToByte(tt); ;
                }
                cstr = bs;
            }
